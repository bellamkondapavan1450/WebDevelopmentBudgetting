...
//     position: 'tr'
//   })
var url ="http://ec2-54-89-185-189.compute-1.amazonaws.com:3000/userdetails"
var name1="";
var email = "";
var profile="";
var user_id ="";
fetch("http://ec2-54-89-185-189.compute-1.amazonaws.com:3000/userdetails",{
    method:'get',
    headers:{
...
.then(result=>{
  ...
  // var data = []
  var url ="http://ec2-54-89-185-189.compute-1.amazonaws.com:3000/mytrans"
  fetch(url,{
      method:'get',
      headers:{
          "Authorization":"Bearer "+ localStorage.getItem("jwt")
